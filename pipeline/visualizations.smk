...
rule visualize_selected_cells:
    input:
        ...
        AL_entropy = expand('data/{{modality}}/Active-Learning_entropy/AL-batches-subset/Active-Learning_entropy-{strat}-rand_sel-{rand}-corr-{corrupt}-{{modality}}-annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA-{cell_num}_cells.tsv',
            strat = selection_expansion_dict['Active-Learning_entropy']['strategy'], rand = selection_expansion_dict['Active-Learning_entropy']['random_selection'], corrupt = selection_expansion_dict['Active-Learning_entropy']['corruption'], cell_num = cell_numbers),
        AL_maxp = expand('data/{{modality}}/Active-Learning_maxp/AL-batches-subset/Active-Learning_maxp-{strat}-rand_sel-{rand}-corr-{corrupt}-{{modality}}-annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA-{cell_num}_cells.tsv',
            strat = selection_expansion_dict['Active-Learning_maxp']['strategy'], rand = selection_expansion_dict['Active-Learning_maxp']['random_selection'], corrupt = selection_expansion_dict['Active-Learning_maxp']['corruption'], cell_num = cell_numbers),
        sce = 'data/{modality}/{modality}-train.rds'
    params:
        output_dir = output + 'reports/',
        random_files = 'data/{modality}/random/',
        seurat_files = 'data/{modality}/Seurat-clustering/',
        AL_files_entropy = 'data/{modality}/Active-Learning_entropy/AL-batches-subset/',
        AL_files_maxp = 'data/{modality}/Active-Learning_maxp/AL-batches-subset/'
    output:
...
def get_predictions(mod, selection):
    if mod == 'scRNASeq':
        if selection == "AL_entropy":
            f = expand(output + 'rare-subtype-benchmarking/scRNASeq-Active-Learning_entropy-{strat}-rand_sel-{rand}-corr-{corrupt}-annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA-{method}-predictions-{cell_num}-cells.tsv', 
                strat = selection_expansion_dict['Active-Learning_entropy']['strategy'], rand = selection_expansion_dict['Active-Learning_entropy']['random_selection'], corrupt = selection_expansion_dict['Active-Learning_entropy']['corruption'], method = evaluation_methods_dict['scRNASeq'], cell_num = cell_numbers)
        elif selection == "AL_maxp":
            f = expand(output + 'rare-subtype-benchmarking/scRNASeq-Active-Learning_maxp-{strat}-rand_sel-{rand}-corr-{corrupt}-annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA-{method}-predictions-{cell_num}-cells.tsv', 
                strat = selection_expansion_dict['Active-Learning_maxp']['strategy'], rand = selection_expansion_dict['Active-Learning_maxp']['random_selection'], corrupt = selection_expansion_dict['Active-Learning_maxp']['corruption'], method = evaluation_methods_dict['scRNASeq'], cell_num = cell_numbers)
        ...
        if selection == "AL_entropy":
            f = expand(output + 'rare-subtype-benchmarking/CyTOF-Active-Learning_entropy-{strat}-rand_sel-{rand}-corr-{corrupt}-annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA-{method}-predictions-{cell_num}-cells.tsv',
                strat = selection_expansion_dict['Active-Learning_entropy']['strategy'], rand = selection_expansion_dict['Active-Learning_entropy']['random_selection'], corrupt = selection_expansion_dict['Active-Learning_entropy']['corruption'], method = evaluation_methods_dict['CyTOF'], cell_num = cell_numbers)
        elif selection == "AL_maxp":
            f = expand(output + 'rare-subtype-benchmarking/CyTOF-Active-Learning_maxp-{strat}-rand_sel-{rand}-corr-{corrupt}-annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA-{method}-predictions-{cell_num}-cells.tsv',
                strat = selection_expansion_dict['Active-Learning_maxp']['strategy'], rand = selection_expansion_dict['Active-Learning_maxp']['random_selection'], corrupt = selection_expansion_dict['Active-Learning_maxp']['corruption'], method = evaluation_methods_dict['CyTOF'], cell_num = cell_numbers)
        elif selection == 'Seurat':
...
rule compare_predicted_to_ground_truth_alluvial:
    ...
    params:
        ...
        AL_pattern_entropy = "{modality}-Active-Learning_entropy-*annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA*-cells*",
        AL_pattern_maxp = "{modality}-Active-Learning_maxp-*annotator-GroundTruth-knn_neighbors-NA-resolution-NA-iterations_set-NA*-cells*",
    ...
    shell:
        ...
        "AL_pattern_maxp = '{params.AL_pattern_maxp}', seurat_pattern = '{params.seurat_pattern}', random_pattern = '{params.random_pattern}'))\" "
